...
RSpec.describe "avaliacoes_fisicas/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit avaliacoes_fisica form" do
    render

    assert_select "form[action=?][method=?]", avaliacoes_fisica_path(@avaliacoes_fisica), "post" do
