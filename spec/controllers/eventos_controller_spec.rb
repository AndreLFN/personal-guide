...
RSpec.describe EventosController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: evento.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      evento = Evento.create! valid_attributes
      get :edit, params: {id: evento.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Evento" do
        expect {
          post :create, params: {evento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {evento: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested evento" do
        evento = Evento.create! valid_attributes
        put :update, params: {id: evento.to_param, evento: new_attributes}, session: valid_session
        evento.reload
      ...
      it "redirects to the evento" do
        evento = Evento.create! valid_attributes
        put :update, params: {id: evento.to_param, evento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        evento = Evento.create! valid_attributes
        put :update, params: {id: evento.to_param, evento: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested evento" do
      evento = Evento.create! valid_attributes
      expect {
        delete :destroy, params: {id: evento.to_param}, session: valid_session
      }.to change(Evento, :count).by(-1)
    end
