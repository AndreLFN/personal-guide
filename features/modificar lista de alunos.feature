...
para me auxiliar no gerenciamento dos alunos.** **
	...
	Scenario outline: Adicionar um novo aluno no personal guide
	...
	Scenario outline: remover um aluno no personal guide
	...
	Scenario outline: Atualizar dados do aluno na lista
